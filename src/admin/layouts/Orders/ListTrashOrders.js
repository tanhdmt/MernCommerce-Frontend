...
import { destroyOrders, listTrashOrders, restoreOrders } from '../../../redux/actions/orderActions';
        ...
        if (deleteItems.length > 0) {
            return(
                <button
                    ...
                    onClick={()=> dispatch(destroyOrders(deleteItems.toString()))}
                >
        ...
        if (deleteItems.length > 0) {
            return(
                <button
                    ...
                    onClick={()=> dispatch(restoreOrders(deleteItems.toString()))}
                >
        ...
        <section className="table-components">
            <div className="container-fluid">
                        ...
                        <div className="col-md-6">
                            <div className="breadcrumb-wrapper mb-30">
                                <nav aria-label="breadcrumb">
                                    ...
                                    >
                                        <i className="fas fa-clipboard-list"></i>&ensp;List Orders
                                    </Link>
                                    &nbsp;
                                    {checkButtonRestore()}
                                    &nbsp;
                ...
                {lstOrders && lstOrders.length 
                    ?<OrderTable list={lstOrders} setDeleteItems={setDeleteItems} />
